# Phase Transitions in Moore-connected Stochastic SIR Epidemic Model
...
- **Evolution:** To accomodate for evolution of infectivity to observe more interesting properties. The `evolve` argument is the switch between evoolving and static pathogen infectivity. Further analysis will be done on this.
...
### Infectivity drift under evolution
<img width="1800" height="600" alt="evolution" src="https://github.com/user-attachments/assets/ef2efc31-95ad-43f6-b9be-08990afd001f" />

### Phase Transition (mobility vs infectivity)
Parameter scan done across a range of 30 mobility and infectivity values, with 20 iterations per value pair.
